...
>
  ...
  <div x-data="{showModal: false}">
    <div
      x-bind:class="{'inset-0 fixed z-10 h-screen w-screen overscroll-contain gap-4 flex': showModal}">
      <div x-bind:class="{'bg-white w-full flex grow grid md:grid-cols-3 relative rounded-lg': showModal}">
        <div x-bind:class="{'p-4 overflow-y-auto flex flex-col w-full': showModal}">
          <div class="flex flex-row justify-between mb-4 items-center">
            ...
            @endif
            <div>
              <x-filament::button x-on:click="showModal = true" x-show="showModal === false">Visual builder</x-filament::button>
              <x-filament::button x-on:click="showModal = false" x-show="showModal === true">Close visual builder</x-filament::button>
            </div>
          </div>
